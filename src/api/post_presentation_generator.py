    ...
    def post(self):
        ...
        if not user_id:
            ...
            if not api_key:
                ...
                data = {"large_language_model": large_language_model, "specific_model_name": model_name,
                        "presentation_topic": topic, "audience_size": audience_size, "presentation_length": time,
